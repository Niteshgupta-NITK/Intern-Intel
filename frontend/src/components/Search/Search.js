...
function Search() {
          ...
          <div className="form-container">
            <form onSubmit={handleSubmit} className="flex space-x-4">
              <Select multiple name="options" className="flex-1">
                ...
                <Option value="option3">Harvard University</Option>
                <Option value="option4">University of Cambridge</Option>
                <Option value="option5">Stanford University</Option>
                <Option value="option6">
                  University of California Berkaly
                </Option>
                <Option value="option7">University of Oxford</Option>
                <Option value="option8">University of Columbia</Option>
  ...
  return (
    <SearchProvider
      ...
      searchOnLoad
    >
      <App website={website} setWebsite={handleChange}/>
    </SearchProvider>
  );
}
